...
- 1st revision
  ...
  | Remove POOR_TITLE | POOR_TITLE table exists | delete table | A separate title table is no longer needed because the title is not managed as a fixed value but is generated by AI each time. |
