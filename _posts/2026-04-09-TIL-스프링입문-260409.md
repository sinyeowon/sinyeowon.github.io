...
description: "Spring MVC에서 @PathVariable, @RequestParam, @ModelAttribute, @RequestBody를 활용해 클라이언트의 다양한 HTTP 요청 데이터를 객체로 매핑하고 처리하는 방법을 학습했다."
english_url: "/en/posts/TIL-스프링입문-260409/"
---
### 오늘 할 일
