...
description: 'Client(브라우저)에서 서버로 HTTP 요청을 보낼 때 데이터를 함께 보낼 수 있음Path Variable 방식: 서버에 보내려는 데이터를 URL 경로에 추가할 수 있음🌐 GET http&#x3A;//localhost:8080/hello/request/star/R'
---
### 오늘 할 일
