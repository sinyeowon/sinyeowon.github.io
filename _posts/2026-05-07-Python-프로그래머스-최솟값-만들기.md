...
description: "https://school.programmers.co.kr/learn/courses/30/lessons/12941 풀이 처음에는 다음과 같이 작성했지만, 효율성 테스트에 통과하지 못함 파이썬에서는 버블 정렬을 따로 사용하지 않고, sort 함수를 통해 간단하게 정렬 가능함 sort 리스"
