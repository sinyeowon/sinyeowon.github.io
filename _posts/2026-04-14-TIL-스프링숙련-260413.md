---
title: '[TIL] 스프링 숙련 TIL - 26/04/13'
date: 2026-04-14 14:36:44 +0900
last_modified_at: 2026-04-25 09:04:08 +0900
categories: ['Spring 단기 심화']
tags: ['Spring', 'TIL', '내일배움캠프']
description: 'Bean 수동 등록Bean 자동 등록: @Component를 사용하면 @ComponentScan에 의해 자동으로 스캔되어 해당 클래스를 Bean으로 등록해줌일반적으로 위처럼 자동 등록함프로젝트의 규모가 커질 수록 등록할 Bean들이 만아지기 때문에 자동등록을 사용하면'
---
## 오늘 할 일
...
#### 웹 어플리케이션 인증의 특수성
![](https://velog.velcdn.com/images/sinyeowon/post/253de067-e77f-4455-ac7b-00bb280433e9/image.png)
...
- 일반적으로 웹 어플리케이션은 두 가지 방법을 통해 인증을 처리함
  ...
  ![](https://velog.velcdn.com/images/sinyeowon/post/be66d03e-9d8d-4285-9147-fb6fb7e97e44/image.png)
    1. 사용자가 로그인 요청을 보냄
  ...
  ![](https://velog.velcdn.com/images/sinyeowon/post/1999c551-715b-476c-a59b-744dc8c1e5d6/image.png)
    1. 사용자가 로그인 요청을 보냄
...
- 쿠키와 세션을 통해 서버에서는 클라이언트 별로 인증 및 인가를 할 수 있게됨
  ...
  - **세션**
    ...
    - 세션 동작 방식
    ![](https://velog.velcdn.com/images/sinyeowon/post/81a7d78b-8f94-4374-a19b-27f49a879784/image.png)
        1. 클라이언트가 서버에 1번 요청
