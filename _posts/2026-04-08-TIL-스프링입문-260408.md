---
title: "[TIL] 스프링 입문 - Controller와 HTTP 매핑"
title_source: "manual"
...
description: "해당 클래스가 Controller의 역할을 수행할 수 있도록 함 Spring MVC는 효율적 API 처리를 위해 Front Controller 패턴을 만들어냄 API 마다 파일을 만들 필요가 없고, 유사한 성격의 API를 하나의 Controller로 관리함"
