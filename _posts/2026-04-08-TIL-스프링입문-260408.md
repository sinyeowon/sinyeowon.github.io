...
description: '해당 클래스가 Controller의 역할을 수행할 수 있도록 함Spring MVC는 효율적 API 처리를 위해 Front Controller 패턴을 만들어냄API 마다 파일을 만들 필요가 없고, 유사한 성격의 API를 하나의 Controller로 관리함@GET, @PO'
---
### 오늘 할 일
