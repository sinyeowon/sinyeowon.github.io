---
title: '[TIL] 스프링 입문 TIL - 26/04/11'
date: 2026-04-12 16:14:24 +0900
last_modified_at: 2026-04-30 16:11:57 +0900
categories: ['Spring 단기 심화']
tags: ['Spring', 'TIL', '내일배움캠프']
description: 'DI를 사용하기 위해 객체 생성이 우선되어야 함하지만 언제, 어디서, 누가 객체를 생성할까?\-> Spring 프레임워크가 필요한 객체를 생성하고 관리하는 역할을 대신 해줌Spring IoC 컨테이너: ''Bean''을 모아둔 컨테이너Bean: Spring이 관리하는 객체'
---
## 오늘 할 일
...
#### 1차 캐시
![](https://velog.velcdn.com/images/sinyeowon/post/a3766dbf-aa47-4b4d-8ecf-7baa96daa9b8/image.png)
...
- Entity 저장
![](https://velog.velcdn.com/images/sinyeowon/post/9f0f5210-c631-47c4-8c91-6dff14748cfb/image.png)
  - `em.persist(memo)` 메서드가 호출되면 memo Entity 객체를 캐시 저장소에 저장함
- Entity 조회
  1. 캐시 저장소에 조회하는 Id가 존재하지 않는 경우
  ![](https://velog.velcdn.com/images/sinyeowon/post/01be6aee-1370-4c5d-8b72-e8bac9e4e0c2/image.png)
![](https://velog.velcdn.com/images/sinyeowon/post/b43bbbe6-9e4a-41dc-96d0-b89e6011c474/image.png)
  ...
  ![](https://velog.velcdn.com/images/sinyeowon/post/40c43c31-d24c-47e2-9fa5-f5ad95dbd66c/image.png)
...
- Entity 삭제
![](https://velog.velcdn.com/images/sinyeowon/post/d39939a7-f69d-4ea6-849f-4c88a7c49b59/image.png)
![](https://velog.velcdn.com/images/sinyeowon/post/1dd52417-1b98-45b8-ac26-6f0b06b07193/image.png)
...
![](https://velog.velcdn.com/images/sinyeowon/post/b890022c-bada-4482-9b6a-0cd93e946025/image.png)
...
- **JPA에서의 Update 처리**
![](https://velog.velcdn.com/images/sinyeowon/post/53970090-25b2-4b01-b38e-bd9272e583e1/image.png)
...
### Entity의 상태
![](https://velog.velcdn.com/images/sinyeowon/post/55f86b28-4c5e-48e1-9d2a-9536b3ac4c56/image.png)
- **비영속 (Transient)**
  `Memo memo = new Memo();`
...
![](https://velog.velcdn.com/images/sinyeowon/post/eadbe695-9b17-42d2-a31a-2e12b730bf0f/image.png)
...
### Spring Data JPA
![](https://velog.velcdn.com/images/sinyeowon/post/205d3944-96fc-4a8f-bc48-50286c9a0fdc/image.png)
> **Spring Data JPA**
...
```
  ...
  ![](https://velog.velcdn.com/images/sinyeowon/post/d96bc2da-404c-4b7a-9c72-1d0557af1e66/image.png)
...
- findAll 메서드를 사용해 해당 테이블의 전체 데이터를 조회할 수 있음
  ![](https://velog.velcdn.com/images/sinyeowon/post/9a49419d-4fbb-4bcf-8490-ac4bd7299a3e/image.png)
...
- SimpleJpaRepository의 findById 메서드를 확인해보면, 반환 타입이 Optional인 것을 확인할 수 있음
  ![](https://velog.velcdn.com/images/sinyeowon/post/d1b954c9-cba5-461e-84ab-952c200d14da/image.png)
...
- delete 메서드를 사용해 해당 Entity(데이터)를 테이블에서 삭제할 수 있음
  ![](https://velog.velcdn.com/images/sinyeowon/post/42811521-f4e5-40f2-b6f4-e776f0f9c1c1/image.png)
