...
categories: ['BaekJoon']
tags: ['Java', 'baekjoon']
description: 'BaekJoone 15552Java에서는 기존에 사용하던 Scanner과 System.out.print보다BufferedReader + StringTokenizer + BufferedWriter를 사용하는 게 나음빠르게 한 줄 읽기사용: import java.io.\*'
---
