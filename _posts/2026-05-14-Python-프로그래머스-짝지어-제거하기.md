...
description: "stack에 알파벳 하나를 넣고, 다음 알파벳을 들고와서 전에 넣은 알파벳과 일치하면 전에 넣은 알파벳을 pop하고, 일치하지 않으면 해당 알파벳도 stack에 넣는 방식 이렇게 하다보면, 모든 알파벳을 대입했을때 짝지어 제거하기에 성공한다면 stack은 비어있어야함"
