...
description: 'DTO (Data Transfer Object): 데이터 전송 및 이동을 위해 생성되는 객체Client에서 보내오는 데이터를 객체로 처리할 때 사용됨서버의 계층간의 이동에 사용된DB와의 소통을 담당하는 Java 클래스를 그대로 Client에 반환하는 것이 아니라 DTO'
---
### 오늘 할 일
