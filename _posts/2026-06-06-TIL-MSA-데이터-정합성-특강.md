...
<details markdown="1">
<summary>**Kafka 프로듀서/컨슈머 설정 (간단 예시)**</summary>
...
<details markdown="1">
<summary>**오케스트레이터(Orchestrator) & 서비스**</summary>
...
<details markdown="1">
<summary>**1. RabbitMQ vs Kafka, 어떤 차이가 있고 Saga 패턴에는 어떻게 적용해야 할까?**</summary>
...
<details markdown="1">
<summary>**2. Orchestration Saga vs Choreography Saga, 언제 어떤 방식을 선택해야 할까?**</summary>
...
<details markdown="1">
<summary>**3. 보상 트랜잭션(Compensation)과 실패 시 재처리는 어떻게 해야 할까?**</summary>
...
<details markdown="1">
<summary>**4. 메시지 중복, 메시지 순서 보장 문제는 어떻게 해결하나요?**</summary>
...
<details markdown="1">
<summary>**5. Kafka 파티션, 토픽 개념이 어렵습니다. 어떻게 이해하고 설정해야 할까요?**</summary>
...
<details markdown="1">
<summary>**6. Choreography 방식으로 복잡한 구조를 구현할 때, 서비스 간 의존성이 커지는 문제와 장애 시 보상 트랜잭션은 어떻게 처리하나요?**</summary>
...
<details markdown="1">
<summary>**7. Update(수정) 시 보상 트랜잭션은 어떻게 관리해야 할까?**</summary>
...
<details markdown="1">
<summary>**8. SAGA 롤백 순서를 임의로 바꿨을 때 데이터 정합성 문제는 없을까?**</summary>
...
<details markdown="1">
<summary>**9. CQRS와 Saga를 함께 적용하면 너무 복잡해집니다. 실무에서는 어느 정도로 관리하나요?**</summary>
...
<details markdown="1">
<summary>**10. SAGA 패턴 테스트는 어떻게 해야 할까?**</summary>
...
<details markdown="1">
<summary>**11. 실제 서비스(현업)에서 SAGA 패턴을 적용할 때 겪은 문제와 해결책이 궁금합니다.**</summary>
...
<details markdown="1">
<summary>**12. MSA에서 분산 트랜잭션이 많아지면 장애 대응, 고가용성, 확장성, 데이터 일관성 등 생각할 게 많습니다. 어떤 접근이 좋을까요?**</summary>
...
<details markdown="1">
<summary>**13. Saga 패턴을 적용할 때 꼭 고려해야 할 핵심 포인트는?**</summary>
...
<details markdown="1">
<summary>**14. 보상 트랜잭션조차 실패할 수 있을 때, Outbox 패턴 말고 추가 대안은 없을까?**</summary>
