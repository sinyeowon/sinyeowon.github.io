...
description: '@Entity 어노테이션이 클래스는 DB 테이블이랑 매핑되는 클래스 라는 것을 알려줌JPA 의존성을 추가해줘야함 -> JPA를 통해 이 클래스를 테이블로 인식함implementation ''org.springframework.boot:spring-boot-starter-'
---
## Entity
